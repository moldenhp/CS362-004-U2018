// cardtest3.c 
// This tests the Council Room Card 
...
// my own assertTrue function - this checkes if two ints are equal or not
...
int main () {
    ...
    assertTrue(state.handCount[player0],stateOriginal.handCount[player0]+4);
